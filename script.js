/* script.js
 Front-end logic:
 - login (pega lista de usuarios do sheet 'Usuarios')
 - listar e buscar Dados, Itens, Config, Log
 - CRUD básico (via API actions)
 - importar Excel (SheetJS) => envia linhas para endpoint 'importItens'
*/
...
async function handleLogin(){
  ...
  try {
    ...
    const found = users.find(u => (u.name||'').toString() === user && (u.password||'').toString() === pass);
    if (!found) {
